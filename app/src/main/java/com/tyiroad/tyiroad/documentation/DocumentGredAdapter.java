...
public class DocumentGredAdapter  extends BaseAdapter {
    ...
    public DocumentGredAdapter(Context context,
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (showType == 1) {
            ...
            if (position == listPicture.size() - 1) {
                vh.pictureCloseImg.setVisibility(View.GONE);
                if (context instanceof DocumentationActivity) {
                    vh.pictureImg.setOnClickListener(new OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            if (minePopupWindow == null) {
                                minePopupWindow = new MinePopupWindow((DocumentationActivity) context, itemOnClick);
                            }
                            minePopupWindow.showAtLocation(parent, Gravity.BOTTOM, 0, 0);
                            Utils.hideInputWindow((DocumentationActivity)context);
                        }
                    });
                }
            } else {
...
//                    context.startActivity(intent);
    ...
    public void getPicFromPhoto() {
        ...
        ((DocumentationActivity) context).startActivityForResult(intent, CHOOSE_PICTURE_CODE);
    }
    ...
    public void getPicFromCamera() {
        ...
        ((DocumentationActivity) context).setCameraPath(path);
        ((DocumentationActivity) context).setChildViewPosition(childViewPosition);
        ((DocumentationActivity) context).startActivityForResult(intent, CAMERA_CODE);
    }
