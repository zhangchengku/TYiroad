...
public class DbQualityGredAdapter  extends BaseAdapter {
    ...
    public DbQualityGredAdapter(Context context,
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (showType == 1) {
            ...
            if (position == listPicture.size() - 1) {
                vh.pictureCloseImg.setVisibility(View.GONE);
                if (context instanceof DbQualityActivity) {
                    vh.pictureImg.setOnClickListener(new OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            if (minePopupWindow == null) {
                                minePopupWindow = new MinePopupWindow((DbQualityActivity) context, itemOnClick);
                            }
                            minePopupWindow.showAtLocation(parent, Gravity.BOTTOM, 0, 0);
                            Utils.hideInputWindow((DbQualityActivity)context);
                        }
                    });
                }
            } else {
...
//                    context.startActivity(intent);
    ...
    public void getPicFromPhoto() {
        ...
        ((DbQualityActivity) context).startActivityForResult(intent, CHOOSE_PICTURE_CODE);
    }
    ...
    public void getPicFromCamera() {
        ...
        ((DbQualityActivity) context).setCameraPath(path);
        ((DbQualityActivity) context).setChildViewPosition(childViewPosition);
        ((DbQualityActivity) context).startActivityForResult(intent, CAMERA_CODE);
    }
