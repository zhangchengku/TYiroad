...
public class OtherAddGridAdapter  extends BaseAdapter {
    ...
    public OtherAddGridAdapter(Context context,
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (showType == 1) {
            ...
            if (position == listPicture.size() - 1) {
                vh.pictureCloseImg.setVisibility(View.GONE);
                if (context instanceof OtherAddActivity) {
                    vh.pictureImg.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            if (minePopupWindow == null) {
                                minePopupWindow = new MinePopupWindow((OtherAddActivity) context, itemOnClick);
                            }
                            minePopupWindow.showAtLocation(parent, Gravity.BOTTOM, 0, 0);
                            Utils.hideInputWindow((OtherAddActivity)context);
                        }
                    });
                }
            } else {
    ...
    public void getPicFromPhoto() {
        ...
        ((OtherAddActivity) context).startActivityForResult(intent, CHOOSE_PICTURE_CODE);
    }
    ...
    public void getPicFromCamera() {
        ...
        ((OtherAddActivity) context).setCameraPath(path);
        ((OtherAddActivity) context).setChildViewPosition(childViewPosition);
        ((OtherAddActivity) context).startActivityForResult(intent, CAMERA_CODE);
    }
