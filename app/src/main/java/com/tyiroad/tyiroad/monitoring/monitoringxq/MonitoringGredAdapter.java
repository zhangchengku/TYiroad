...
public class MonitoringGredAdapter  extends BaseAdapter {
    ...
    public MonitoringGredAdapter(Context context,
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (showType == 1) {
            ...
            if (position == listPicture.size() - 1) {
                vh.pictureCloseImg.setVisibility(View.GONE);
                if (context instanceof MonitoringXQActivity) {
                    vh.pictureImg.setOnClickListener(new OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            if (minePopupWindow == null) {
                                minePopupWindow = new MinePopupWindow((MonitoringXQActivity) context, itemOnClick);
                            }
                            minePopupWindow.showAtLocation(parent, Gravity.BOTTOM, 0, 0);
                            Utils.hideInputWindow((MonitoringXQActivity)context);
                        }
                    });
                }
            } else {
...
//                    context.startActivity(intent);
    ...
    public void getPicFromPhoto() {
        ...
        ((MonitoringXQActivity) context).startActivityForResult(intent, CHOOSE_PICTURE_CODE);
    }
    ...
    public void getPicFromCamera() {
        ...
        ((MonitoringXQActivity) context).setCameraPath(path);
        ((MonitoringXQActivity) context).setChildViewPosition(childViewPosition);
        ((MonitoringXQActivity) context).startActivityForResult(intent, CAMERA_CODE);
    }
