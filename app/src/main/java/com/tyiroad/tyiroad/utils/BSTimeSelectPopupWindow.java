...
import com.tyiroad.tyiroad.yjbs.YjbsActivity;
...
public class BSTimeSelectPopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public BSTimeSelectPopupWindow(Activity activity, PopSelectListener listener) {
