...
import com.tyiroad.tyiroad.utils.OnWheelChangedListener;
import com.tyiroad.tyiroad.utils.OnWheelScrollListener;
import com.tyiroad.tyiroad.utils.PopMyDataSelectAdapter;
import com.tyiroad.tyiroad.utils.PopSelectListener;
import com.tyiroad.tyiroad.utils.WheelView;
...
public class DBTimePopupWindow extends PopupWindow implements View.OnClickListener {
    ...
    public DBTimePopupWindow(Activity activity, PopSelectListener listener) {
    ...
    private void initViews(View contentView) {
        ...
        setOnDismissListener(new OnDismissListener() {
            ...
            public void onDismiss() {
                if (activity instanceof DBMonitoringActivity) {
                    ((DBMonitoringActivity) activity).hideZheZhaoView();
                }
            }
        });
    ...
    public void show(View anchor) {
        ...
        if (anchor != null) {
            ...
            if (activity instanceof DBMonitoringActivity) {
                ((DBMonitoringActivity) activity).showZheZhaoView();
            }
        }
    }
