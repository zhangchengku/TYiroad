...
public class OtherNoExamineTime  extends PopupWindow implements View.OnClickListener {
    ...
    public OtherNoExamineTime(Activity activity, PopSelectListener listener) {
