...
public class BsGredAdapter extends BaseAdapter {
    ...
    public BsGredAdapter(Context context,
    ...
    public View getView(int position, View convertView, final ViewGroup parent) {
        ...
        if (showType == 1) {
            ...
            if (position == listPicture.size() - 1) {
                vh.pictureCloseImg.setVisibility(View.GONE);
                if (context instanceof YjbsActivity) {
                    vh.pictureImg.setOnClickListener(new OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            if (minePopupWindow == null) {
                                minePopupWindow = new MinePopupWindow((YjbsActivity) context, itemOnClick);
                            }
                            minePopupWindow.showAtLocation(parent, Gravity.BOTTOM, 0, 0);
                            Utils.hideInputWindow((YjbsActivity)context);
                        }
                    });
                }
            } else {
...
//                    context.startActivity(intent);
    ...
    public void getPicFromPhoto() {
        ...
        ((YjbsActivity) context).startActivityForResult(intent, CHOOSE_PICTURE_CODE);
    }
    ...
    public void getPicFromCamera() {
        ...
        ((YjbsActivity) context).setCameraPath(path);
        ((YjbsActivity) context).setChildViewPosition(childViewPosition);
        ((YjbsActivity) context).startActivityForResult(intent, CAMERA_CODE);
    }
